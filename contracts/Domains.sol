...
contract Domains is ERC721URIStorage {
    ...
    constructor(string memory _tld) payable ERC721("Creator name service", "CNS") {
        tld = _tld;
        console.log("domain name service deployed for tld %s", tld);
    }
    ...
    function register(string calldata name) public payable {
      ...
      string memory json = Base64.encode(
        abi.encodePacked(
          '{"name": "',
          _name,
          '", "description": "A domain on the Creator name service", "image": "data:image/svg+xml;base64,',
